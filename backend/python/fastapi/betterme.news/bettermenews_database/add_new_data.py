...
def test_create_data(url,name,html_type,thumbnail_link,slide_show_link,description,tags):
  ###############done
...
def create_data(url,name,html_type,thumbnail_link,slide_show_link,description,tags):
  ######################done
